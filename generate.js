...
function postProcessContent(html, dateId) {
  ...
  <div class="hero-line" style="left:7%"></div>
  <div class="hero-line" style="right:7%"></div>
  <div class="hero-dot" style="top:20%;left:12%;animation:heroPulse 2.2s ease-in-out infinite"></div>
  <div class="hero-dot" style="top:65%;left:17%;animation:heroPulse 2.8s ease-in-out infinite .5s"></div>
  <div class="hero-dot" style="top:30%;right:13%;animation:heroPulse 2.5s ease-in-out infinite 1s"></div>
  <div class="hero-dot" style="top:70%;right:19%;animation:heroPulse 2s ease-in-out infinite 1.5s"></div>
  <div class="hero-dot" style="top:48%;left:33%;animation:heroPulse 3s ease-in-out infinite .3s;background:#a78bfa"></div>
  <div class="hero-dot" style="top:42%;right:33%;animation:heroPulse 2.6s ease-in-out infinite .8s;background:#a78bfa"></div>
  <div class="report-title-badge">◈ DAILY INTELLIGENCE · 每日情报</div>
  <h1 class="report-main-title">全球车型销售趋势与车配动态</h1>
...
function sharedStyles() {
  return `<style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* === Report Hero Banner — Sci-Fi === */
    .report-title-hero {
      text-align: center; padding: 52px 24px 44px;
      margin: -36px -40px 40px;
      background: linear-gradient(180deg, #020c1b 0%, #071528 50%, #0c1e3c 100%);
    ...
    .report-title-hero::after {
      ...
      background: linear-gradient(90deg, transparent 0%, #00e5ff 30%, #7c3aed 50%, #00e5ff 70%, transparent 100%);
    }
    /* Scan line */
    @keyframes heroScan {
      0%   { top: -1px; opacity: 0; }
    ...
    /* Perspective grid */
    .hero-grid {
      position: absolute; bottom: 0; left: -15%; right: -15%; height: 52%;
      background-image:
      ...
      transform: perspective(160px) rotateX(44deg);
      transform-origin: bottom center;
      pointer-events: none;
    }
    /* HUD corner brackets */
    .hero-corner { position: absolute; width: 18px; height: 18px; }
    .hero-tl { top: 10px; left: 10px; border-top: 1.5px solid rgba(0,229,255,.65); border-left: 1.5px solid rgba(0,229,255,.65); }
    .hero-tr { top: 10px; right: 10px; border-top: 1.5px solid rgba(0,229,255,.65); border-right: 1.5px solid rgba(0,229,255,.65); }
    .hero-bl { bottom: 10px; left: 10px; border-bottom: 1.5px solid rgba(0,229,255,.65); border-left: 1.5px solid rgba(0,229,255,.65); }
    .hero-br { bottom: 10px; right: 10px; border-bottom: 1.5px solid rgba(0,229,255,.65); border-right: 1.5px solid rgba(0,229,255,.65); }
    /* Side lines */
    .hero-line {
      position: absolute; top: 0; bottom: 0; width: 1px;
      background: linear-gradient(180deg, transparent, rgba(0,229,255,.3) 40%, rgba(0,229,255,.3) 60%, transparent);
      pointer-events: none;
    }
    /* Pulsing dots */
    @keyframes heroPulse {
    ...
    .hero-dot {
      ...
      background: #00e5ff; pointer-events: none;
    }
    /* Badge */
    .report-title-badge {
      position: relative; z-index: 1; display: inline-flex; align-items: center; gap: 6px;
      background: rgba(0,229,255,.08); border: 1px solid rgba(0,229,255,.4);
    ...
    .report-main-title {
      ...
      font-size: 32px !important; font-weight: 800 !important; color: #fff !important;
      letter-spacing: .04em; margin: 0 0 14px !important;
      text-shadow: 0 0 24px rgba(0,229,255,.5), 0 0 48px rgba(0,229,255,.2), 0 2px 16px rgba(0,0,0,.9);
      border: none !important; padding: 0 !important;
    }
    .report-title-date {
      position: relative; z-index: 1;
      font-size: 13px; color: rgba(0,229,255,.8); margin-bottom: 22px;
    ...
    .report-title-markets span {
      ...
      color: rgba(255,255,255,.75); padding: 3px 11px; border-radius: 2px;
